...
Public Class Mainform
    ...
    Private ReadOnly updateBaseUrl As String = "http://localhost/l2shin.com/updater/"
    Private ReadOnly manifestUrl As String = "http://localhost/l2shin.com/updater/manifest.txt"
    Private ReadOnly newsUrl As String = "http://localhost/l2shin.com/news/news.txt"
    ...
    Private Sub BtnUserpanel_Click(sender As Object, e As EventArgs) Handles btnUserpanel.Click
        OpenURL("https://www.l2shin.com/login.php")
    End Sub
    ...
    Private Sub OpenSocialMedia(sender As Object, e As EventArgs) Handles btnDiscord.Click, btnIG.Click
        ...
        If sender Is btnDiscord Then
            url = "https://discord.gg/JFrzy9CcpK"
        ElseIf sender Is btnIG Then
            url = "https://www.instagram.com/l2.shin"
        End If
